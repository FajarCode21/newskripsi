...
const machineService = {
  ...
  createMachine: async (code, name, type, location, install_date) => {
    const { rows } = await pool.query(
  ...
  updateMachine: async (id, code, name, type, location, install_date) => {
    const { rows } = await pool.query(
